 ...
 */
public class WifiDirectAutoAcceptHelper {
     ...
     */
    private WifiDirectAutoAcceptHelper(Context context, WifiP2pManager m, WifiP2pManager.Channel c) {
     ...
     * manager and channel.
     */
    public WifiDirectAutoAcceptHelper(WifiP2pManager manager, WifiP2pManager.Channel channel) {
     ...
     */
    public WifiDirectAutoAcceptHelper(Context context) {
